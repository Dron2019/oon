...
export default function(props) {
    ...
    const consultQuestionInitForm = [
        {name:'message', initialValue: '', signUpSchema:()=>{ return false; }, type:'textarea', placeholder:'Уведіть ваше запитання:', validation:(value)=>{
        ...
        <div className="cabinet-inner-double-part-wrapper">
            ...
            <Formik 
                ...
                <Form className="form-std">
                    ...
                    {consultQuestionInitForm.map(configField=>{
